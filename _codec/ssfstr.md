...
|---|----------|-------------|
| [e.g.](#ex-isvalid) | [`SSFStrIsValid(cstr, cstrSize)`](#ssfstrisvalid) | Return true if a null terminator exists within the buffer |
| [e.g.](#ex-len) | [`SSFStrLen(cstr, cstrSize, cstrLenOut)`](#ssfstrlen) | Return the length of a bounded C string |
| [e.g.](#ex-cpy) | [`SSFStrCpy(dst, dstSize, dstLenOut, src, srcSize)`](#ssfstrcpy) | Safe string copy; always null-terminates on success |
| [e.g.](#ex-cat) | [`SSFStrCat(dst, dstSize, dstLenOut, src, srcSize)`](#ssfstrcat) | Safe string concatenation; always null-terminates on success |
| [e.g.](#ex-cmp) | [`SSFStrCmp(cstr1, cstr1Size, cstr2, cstr2Size)`](#ssfstrcmp) | Safe string equality comparison |
| [e.g.](#ex-tocase) | [`SSFStrToCase(cstrOut, cstrOutSize, toCase)`](#ssfstrtocase) | Convert string to upper or lower case in-place |
| [e.g.](#ex-str) | [`SSFStrStr(cstr, cstrSize, matchStrOptOut, substr, substrSize)`](#ssfstrstr) | Find the first occurrence of a substring |
| [e.g.](#ex-tok) | [`SSFStrTok(cstr, cstrSize, tokenOut, tokenSize, tokenLenOut, delims, delimsSize)`](#ssfstrtok) | Extract the next token from a string |
...
### [↑](#ssfstr--safe-c-string-interface) [`SSFStrIsValid()`](#ex-isvalid)
...
### [↑](#ssfstr--safe-c-string-interface) [`SSFStrLen()`](#ex-len)
...
### [↑](#ssfstr--safe-c-string-interface) [`SSFStrCpy()`](#ex-cpy)
...
### [↑](#ssfstr--safe-c-string-interface) [`SSFStrCat()`](#ex-cat)
...
### [↑](#ssfstr--safe-c-string-interface) [`SSFStrCmp()`](#ex-cmp)
...
### [↑](#ssfstr--safe-c-string-interface) [`SSFStrToCase()`](#ex-tocase)
...
### [↑](#ssfstr--safe-c-string-interface) [`SSFStrStr()`](#ex-str)
...
### [↑](#ssfstr--safe-c-string-interface) [`SSFStrTok()`](#ex-tok)
...
## [↑](#ssfstr--safe-c-string-interface) Examples

<a id="ex-isvalid"></a>

### [↑](#ssfstr--safe-c-string-interface) [SSFStrIsValid()](#ssfstrisvalid)
...
### [↑](#ssfstr--safe-c-string-interface) [SSFStrLen()](#ssfstrlen)
...
### [↑](#ssfstr--safe-c-string-interface) [SSFStrCpy()](#ssfstrcpy)
...
### [↑](#ssfstr--safe-c-string-interface) [SSFStrCat()](#ssfstrcat)
...
### [↑](#ssfstr--safe-c-string-interface) [SSFStrCmp()](#ssfstrcmp)
...
### [↑](#ssfstr--safe-c-string-interface) [SSFStrToCase()](#ssfstrtocase)
...
### [↑](#ssfstr--safe-c-string-interface) [SSFStrStr()](#ssfstrstr)
...
### [↑](#ssfstr--safe-c-string-interface) [SSFStrTok()](#ssfstrtok)
