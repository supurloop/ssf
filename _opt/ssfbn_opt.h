...
/* enabled operand width x 2, since RSA keygen, CRT recombine, ModInvExt over lambda(n), and ECC's*/
/* SSFBNModMulNIST all run intermediate products at up to 2*N bits (full-width n x n).          */
/*                                                                                              */
